...
| TD-02 | JWT в `localStorage` (XSS → кража сессии) | ADR-0010: Stage 1 Bearer оставлен сознательно | cookie / Secure Storage **до native и публичного prod** |
...
| TD-14 | Категории Казани «до 15/до 19» vs U14/U18 | закрыт 2026-08-31: ADR-0007 accepted, канон IWWF | — |
